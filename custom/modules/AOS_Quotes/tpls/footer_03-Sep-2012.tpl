...
{literal}
<script type="text/javascript" language="Javascript" src="http://www.tinymce.com/js/tinymce/jscripts/tiny_mce/tiny_mce.js"></script>
<script type="text/javascript"> 
var myVar;
myVar = setTimeout(function(){timecall();},2000);
function timecall() {
...
//alert(df);
	tinyMCE.init({
			...
			mode: "exact",
				elements : "quote_cover_letter,quote_introduction,quote_final_notes,importantdetails_c",
