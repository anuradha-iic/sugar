...
{ lineno=ln;
	var popupRequestData = {
		...
		"field_to_name_array" : {
			...
			"description"  : "product_descriptionFetch"+ln	
		}
	};
...
{  
	...
	{   
		...
		else
		{
			...
			alert(document.getElementById('product_descriptionFetch0').value);
			if(theKey.indexOf('product_descriptionFetch') != -1){
				tmpProAr = theKey.split('product_descriptionFetch'); //console.log(tmpProAr);
				document.getElementById('quotes_product_description'+tmpProAr[1]).value = displayValue;
			}
		}
	}
