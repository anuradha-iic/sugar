...
//	e.innerHTML="<input type='text' name='product_unit_price[]' id='product_unit_price" + ln + "' size='10' maxlength='50' value='' title='' tabindex='116' onfocus='calculateDiscount(" + ln + ");' onblur='calculateDiscount(" + ln + "); calculateProductLine(" + ln + ");'>";
	...
	i.innerHTML = SUGAR.language.get(module, 'LBL_PRODUCT_QUOTE_DESCRIPTION') +" <br/>&nbsp;&nbsp;&nbsp;" +SUGAR.language.get(module, 'LBL_PRODUCT_QUOTE_DESC') +" &nbsp;<br/>&nbsp;&nbsp;&nbsp;&nbsp;" +SUGAR.language.get(module, 'LBL_PRODUCT_NOTE')+" :&nbsp";
	j.innerHTML="<input type='text'id='quotes_product_description"+ln+"' name='quotes_product_description[]' value='' /><br><input type='text' name='quotes_product_name[]'  id='quotes_product_name"+ln+"' /><textarea tabindex='116' name='product_note[]' id='product_note" + ln + "' rows='2' cols='53'></textarea>&nbsp;&nbsp;";
