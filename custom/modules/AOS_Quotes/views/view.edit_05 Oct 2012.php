...
$html .= "<td class='dataField'><input type='hidden' name='service_address_id[]' rel='service_address_rel'  id='service_address_id$i' value='".$row['service_address_id']."'><input type='text' name='service_address_name[]' id='service_address_name$i' readonly='readonly' style='width:55px;' value=''></td>";
