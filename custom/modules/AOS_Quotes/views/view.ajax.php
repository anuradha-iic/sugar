...
class AOS_QuotesViewAjax { 
	...
	{  
       // $totalcheckuncheck = '';
	    ...
	    $data = "<table cellpadding='0' cellspacing='0' border='0' width='126%'><tr><td colspan='5' style='font-size: 12pt; font-weight: bold;' valign='top'>Please select the Contact(s) to show on the SOF template.</td></tr> <tr> <td colspan='5' style='font-size: 12pt; font-weight: bold;' valign='top'>&nbsp;</td></tr> <tr> <th style='text-align: left;'>&nbsp;</th> <th style='text-align: left;'>Role</th> <th style='text-align: left;'>Name</th> <th style='text-align: left;'>Work</th> <th style='text-align: left;'>Mobile</th> <th style='text-align: left;'>Email</th> </tr>";
		$checkforContacts = "";
     ...
     else
     {
	    ...
	    $data .= '<tr> <td colspan="6" style="font-size: 12pt; font-weight: bold;" valign="top"> <input type="button" name="getContacts" id="getContacts" value="Update Account Contact List" onClick="addContactsByAccount();" /> </td></tr>';
