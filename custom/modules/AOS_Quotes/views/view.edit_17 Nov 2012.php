...
$html .= "<td class='dataField'><input type='hidden' name='product_deleted[]' id='product_deleted$i' value='0'><input type='hidden' name='product_quote_id[]' value='".$row['id']."'><button type='button' class='button' value='".$mod_strings['LBL_REMOVE_PRODUCT_LINE']."' tabindex='116' onclick='markProductLineDeleted($i)'><input type='hidden' name='is_service[]' value='0' /><img src='themes/default/images/id-ff-clear.png' alt='".$mod_strings['LBL_REMOVE_PRODUCT_LINE']."'></button></td>";
			...
			$html .= "<td class='dataField' align='right' style='padding:0px;margin:0px;vertical-align:top'><table border='0' cellspacing='3' cellpadding='0' ><tr><td class='dataField' align='right' >".$mod_strings['LBL_PRODUCT_QUOTE_DESCRIPTION']."&nbsp;</td></td></tr><tr><td class='dataField' align='right' >".$mod_strings['LBL_PRODUCT_QUOTE_DESC']." :&nbsp;</td></td></tr><tr><td class='dataField' align='right' >".$mod_strings['LBL_PRODUCT_QUOTE_NOTE'].":&nbsp</td></tr></table></td>";
			$html .= "<td class='dataField' colspan='6'><table border='0' cellspacing='0' cellpadding='0' > <tr><td class='dataField' align='left' > <input type='text'id='quotes_product_description$i' name='quotes_product_description[]' value='".$quotes_product_description_c."' /></td></tr><tr><td class='dataField' align='left' > <input type='hidden' name='product_descriptionFetch[$i]' id='product_descriptionFetch$i' value='".$product_descr."'><input type='text'id='quotes_product_name$i' name='quotes_product_name[]' value='".$row['quotes_product_name']."' /></td></tr><tr><td class='dataField' align='left'><textarea tabindex='116' name='product_note[]' id='product_note$i' rows='2' cols='53'>".$row['description']."</textarea></td></tr></table></td>";
