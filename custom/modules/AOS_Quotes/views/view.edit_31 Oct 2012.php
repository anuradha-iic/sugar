...
$dbconfigVars = $dbconfig['db_host_name'].";".$dbconfig['db_user_name'].";".$dbconfig['db_password'].";".$dbconfig['db_name'];		  
		...
		{    // Edit Quotes
			...
			{ 
			   ...
			   $tempdivHTMLtoadd .= '<table cellpadding="0" cellspacing="0" border="0" width="126%"><tr><td colspan="6" style="font-size: 12pt; font-weight: bold;" valign="top">Select the Contacts to show on the SOF template</td></tr> <tr> <td colspan="6" style="font-size: 12pt; font-weight: bold;" valign="top">&nbsp;</td></tr> <tr> <th style="text-align: left;">&nbsp;</th> <th style="text-align: left;">Role</th> <th style="text-align: left;">Name</th> <th style="text-align: left;">Work</th> <th style="text-align: left;">Mobile</th> <th style="text-align: left;">Email</th> </tr>';   
				 foreach($contacts as $key=>$val)
		           { 	
					   ...
					   $tempdivHTMLtoadd .= '<input type="checkbox" checked="checked" onclick="checkfor(this);" name="contactsdisplay_'.$key.'" id="contactsdisplay_'.$key.'" value="'.$val['contacts_id'].'"> '; 	 
			           $tempdivHTMLtoadd .= '</td><td valign="top" style="width: 14%">'.chunk_split($opportunity_role_c, 17, "<br />").'</td><td valign="top" style="width: 14%"> <a href="http://sugarcrm-dev.nextlevelinternet.com/index.php?module=Contacts&return_module=Contacts&action=EditView&record='.$val['id'].'"> '.$val['contact_name'].' </a></td>';
