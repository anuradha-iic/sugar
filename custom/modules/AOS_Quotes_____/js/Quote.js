...
//	e.className="dataField";
	...
	a.innerHTML="<input type='text' name='product_qty[]' id='product_qty" + ln + "' size='6' maxlength='6' value='' title='' tabindex='116' onblur='getListPriceFromLookup("+ln+");Quantity_formatNumber(" + ln + ");calculateProductLine(" + ln + ");'>";
	...
	d.innerHTML="<input type='text' name='product_discount[]' id='product_discount" + ln + "' size='10' maxlength='50' value='' title='' tabindex='116' onfocus='calculateDiscount(" + ln + ");' onblur='calculateDiscount(" + ln + ");'><input type='hidden' name='product_discount_amount[]' id='product_discount_amount" + ln + "' value=''  />";
...
//	e.innerHTML="<input type='text' name='product_unit_price[]' id='product_unit_price" + ln + "' size='10' maxlength='50' value='' title='' tabindex='116' onfocus='calculateDiscount(" + ln + ");' onblur='calculateDiscount(" + ln + "); calculateProductLine(" + ln + ");'>";
	f.innerHTML="<input type='text' name='vat_amt[]' id='vat_amt" + ln + "' size='10' maxlength='250' value='' title='' tabindex='116' >";	
...
r_period.innerHTML = "<input style='width:30px' tabindex='116' name='product_service_period[]' id='product_service_period" + ln + "' value='12' />";
s_period.innerHTML ="<input style='width:30px' tabindex='116' name='product_renewal_period[]' id='product_renewal_period" + ln + "' value='24' />";
        service_address.innerHTML = 
'<input type="hidden" name="service_address_id[]" id="service_address_id' + ln + '" value=""><input type="text" name="service_address_name[]" id="service_address_name' + ln + '" value="">';
	...
	m.innerHTML=SUGAR.language.get(module, 'LBL_SUBTOTAL_MONTHLY_TAX_TOTAL')+" %&nbsp; :&nbsp;&nbsp;<select tabindex='116' name='vat[]' id='vat" + ln + "' onchange='calculateProductLine(" + ln + ");'>"+ vat_hidden.replace("value='11","SELECTED value='11") +"</select>";
...
function insertServiceLine(ln)
{
	...
	a.innerHTML="<input type='text' name='product_qty[]' id='service_qty" + ln + "' size='6' maxlength='6' value='' title='' tabindex='116' onblur='getServiceListPriceFromLookup("+ln+");'>";
...
return;
	...
	open_popup('nli_ServiceAddresses', 800, 850, '&account_id='+document.getElementById('billing_account_id').value, true, true, popupRequestData);
...
function calculateServiceGrandTotals(){
	...
	YUI().use("node","node-base", function(Y){
		...
		Y.one("#total_nrc_subtotal").set('value',subTotal);
