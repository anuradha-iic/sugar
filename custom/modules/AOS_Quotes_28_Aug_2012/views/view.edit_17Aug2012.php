...
class AOS_QuotesViewEdit extends ViewEdit {
	...
	//	$html .= "<th width='5%' class='dataLabel' style='text-align: left;'>".$mod_strings['LBL_UNIT_PRICE']."</th>";
		...
		$html .= "<th width='5%' class='dataLabel' style='text-align: center;'>".$mod_strings['LBL_SERVICE_PERIOD']."</th>";
		...
		if($i == 0)
		{
			...
			$html .= "<td class='dataField'><input tabindex='116' type='text' name='product_qty[$i]' id='product_qty$i' size='8' maxlength='10' value='".rtrim(rtrim(format_number($row['product_qty']), '0'),$sep[1])."' title='' onblur='getListPriceFromLookup($i); Quantity_formatNumber($i);calculateProductLine($i);'></td>";
...
$html .= "<td class='dataField'><input tabindex='116' type='text' name='vat_amt[]' id='vat_amt$i' size='10' maxlength='50' value='".format_number($row['vat_amt'])."'  title=''></td>";		  	
global $timedate;
...
$html .= "<td class='dataField' align='center'><input style='width:30px' tabindex='116' name='product_service_period[]' id='product_service_period$i' value='". $row['product_service_period']."' /></td>";
...
*/
$html .= "<td class='dataField' align='center' ><input style='width:30px' tabindex='116' name='product_renewal_period[]' id='product_renewal_period$i' value='". $row['product_renewal_period']."' /></td>";
...
$html .= "<td class='dataField'><input type='hidden' name='product_deleted[]' id='product_deleted$i' value='0'><input type='hidden' name='product_quote_id[]' value='".$row['id']."'><button type='button' class='button' value='".$mod_strings['LBL_REMOVE_PRODUCT_LINE']."' tabindex='116' onclick='markProductLineDeleted($i)'><input type='hidden' name='is_service[]' value='0' /><img src='themes/default/images/id-ff-clear.png' alt='".$mod_strings['LBL_REMOVE_PRODUCT_LINE']."'></button></td>";
	  ...
	  /*<input type="hidden" name="total_nrc" id="total_nrc" >*/
		...
		<input type="hidden" name="total_lmd" id="total_lmd" >
                  </div> ';
		...
		if($k == 0)
		{
			...
			$html .= "</tr>";
		  	*/
                        ...
                        $html .= "<tr id='service_line$k'>";
                        $html .= "<td class='dataField'><input type='text' name='product_qty[]' id='service_qty$k' size='8' maxlength='6' value='".rtrim(rtrim(format_number($row['product_qty']), '0'),$sep[1])."' title='' tabindex='116' onblur='getServiceListPriceFromLookup($k);'></td>" ;
...
tinyMCE.init({
    			...
    			mode: "exact",
			elements : "quote_cover_letter,quote_introduction,quote_final_notes",
