...
foreach($data as $key=>$val)
{
 ...
 <form name="manageform<?php echo $i; ?>" id="manageform<?php echo $i; ?>" method="post" action="">
          <input type="hidden" value="<?php echo $val['id']; ?>" id="AddBillContactID<?php echo $i; ?>" name="AddBillContactID<?php echo $i; ?>">
			...
			<tr>
				<td colspan="4">
					   <h2 style="border-top: 1px solid #E3E3E3; font: 18px arial; padding-bottom: 5px;">  
							   Additional <?php echo $i; ?> Billing Contact 
					   </h2>
				</td>
			</tr>   	
			<tr>
				...
				<td width="25%" valign="top">
					<select id="updateMultiplesalutation<?php echo $i; ?>" name="updateMultiplesalutation<?php echo $i; ?>" tabindex="100<?php echo $i; ?>">   
				...
				<td width="25%" valign="top">
					   Additional Billing
					   <input type="hidden" value="<?php echo $val['contacttype_c']; ?>" maxlength="25" size="25" id="updateMultiplecontacttype_c<?php echo $i; ?>" name="updateMultiplecontacttype_c<?php echo $i; ?>" tabindex="100<?php echo $i; ?>">
				</td>	
			</tr>
			<tr>
				...
				<td width="47%" valign="top" colspan="3">
					 <input type="text" value="<?php echo $val['first_name']; ?>" maxlength="25" size="25" id="updateMultiplefirst_name<?php echo $i; ?>" name="updateMultiplefirst_name<?php echo $i; ?>" tabindex="100<?php echo $i; ?>">
				</td>
			</tr>
			<tr>
				...
				<td width="25%" valign="top">
					 <input type="text" tabindex="100<?php echo $i; ?>" title="" value="<?php echo $val['last_name']; ?>" maxlength="100" size="30" id="updateMultiplelast_name<?php echo $i; ?>" name="updateMultiplelast_name<?php echo $i; ?>"> 
				</td>
				<td width="25%" valign="top" scope="row" id="phone_work_label">
						<div style="float: right"> Office Phone: </div>
				</td>
				<td width="25%" valign="top">
					 <input type="text" class="phone" tabindex="100<?php echo $i; ?>" title="" value="<?php echo $val['phone_work']; ?>" maxlength="100" size="30" id="updateMultiplephone_work<?php echo $i; ?>" name="updateMultiplephone_work<?php echo $i; ?>">
				</td>
            </tr>
			<tr>
				...
				<td width="25%" valign="top">
					<input type="text" tabindex="100<?php echo $i; ?>" title="" value="<?php echo $val['title']; ?>" maxlength="100" size="30" id="updateMultipletitle<?php echo $i; ?>" name="updateMultipletitle<?php echo $i; ?>"> 
				</td>
				<td width="25%" valign="top" scope="row" id="phone_mobile_label">
					<div style="float: right"> Mobile: </div>
				</td>
				<td width="25%" valign="top">
					<input type="text" class="phone" tabindex="100<?php echo $i; ?>" title="" value="<?php echo $val['phone_mobile']; ?>" maxlength="100" size="30" id="updateMultiplephone_mobile<?php echo $i; ?>" name="updateMultiplephone_mobile<?php echo $i; ?>">
				</td>
            </tr>
			<tr>
				...
				<td width="25%" valign="top">
					<input type="text" tabindex="100<?php echo $i; ?>" title="" value="<?php echo $val['department']; ?>" maxlength="255" size="30" id="updateMultipledepartment<?php echo $i; ?>" name="updateMultipledepartment<?php echo $i; ?>"> 
				</td>
				<td width="25%" valign="top" scope="row" id="phone_fax_label">
					<div style="float: right"> Fax: </div>
				</td>
				<td width="25%" valign="top">
					<input type="text" class="phone" tabindex="100<?php echo $i; ?>" title="" value="<?php echo $val['phone_fax']; ?>" maxlength="100" size="30" id="updateMultiplephone_fax<?php echo $i; ?>" name="updateMultiplephone_fax<?php echo $i; ?>">
				</td>
            </tr>
            <tr>
				<td colspan="4">
				  <div style="float: right;">
					<input type="button" name="update" id="update" value="Update" onclick="checkform(<?php echo $i; ?>, 'AddBillContactID', '<?php echo $record; ?>', 'update_multiple_billing_contacts.php');" /> &nbsp;
					<input type="button" name="delete" id="delete" value="Delete" onclick="javascript: deleteCont(<?php echo $i; ?>, '<?php echo $record; ?>', 'update_multiple_billing_contacts.php', 'AddBillContactID');" />
				  </div>	
				</td>
			</tr> 			
		    <?php 
