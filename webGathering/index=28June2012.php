...
<tr>
    <td colspan="4" style="">&nbsp;
	     <div style="float: right">
	         <input type="button" value="Save" name="useSubmitinner1" onclick="javascript: document.actionform.submit()">
		 </div>	 
	</td>
</tr> 
</table>
...
<tr>
    <td colspan="4">&nbsp;
	     <div style="float: right">
	          <input type="button" value="Save" name="useSubmitinner3" onclick="javascript: document.actionform.submit()">
		 </div>	  
	</td>
</tr>
<tr>
...
<tr>
    <td colspan="4">&nbsp;
	    <div style="float: right">
	        <input type="button" value="Save" name="useSubmitinner2" onclick="javascript: document.actionform.submit()">
		</div>	
	</td>
</tr>
</table>
