...
"}" accessKey="{sugar_translate label="<?php echo $this->_tpl_vars['displayParams']['accessKeySelect']; ?>
...
"}" accessKey="{sugar_translate label="<?php echo $this->_tpl_vars['displayParams']['accessKeyClear']; ?>
