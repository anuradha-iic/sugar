...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getimagepath', 'modules/Connectors/connectors/sources/ext/rest/insideview/tpls/InsideView.tpl', 93, false),)), $this); ?>
...
" border="0" style='position: absolute; top: -8px; right: -9px;'></a>
      ...
      <div style="font-size: 14px;">
      	<a href='http://www.insideview.com/SUGARCRM/' target='_blank' style='text-decoration: none; font-size: 14px;'><strong style='color: #d71e00;'><?php echo $this->_tpl_vars['connector_language']['LBL_TAGLINK']; ?>
</strong></a> <strong><?php echo $this->_tpl_vars['connector_language']['LBL_TAGLINE']; ?>
</strong>
      </div>
...
<br><?php echo $this->_tpl_vars['connector_language']['iv_description1']; ?>
<strong><?php echo $this->_tpl_vars['connector_language']['iv_description2']; ?>
</strong><?php echo $this->_tpl_vars['connector_language']['iv_description3']; ?>
<br/><?php echo $this->_tpl_vars['connector_language']['iv_description4']; ?>
...
" align="left"/></a><a href='http://www.insideview.com/SUGARCRM/' target='_blank' style='text-decoration: none; position: relative; top: 15px;'><?php echo $this->_tpl_vars['connector_language']['LBL_VID0']; ?>
<br><?php echo $this->_tpl_vars['connector_language']['LBL_VID1']; ?>
</a></div>
      
               <hr style="width: 775px; border-color: #eee; background-color: #eee;">
     <form>
     <input type="checkbox" class="checkbox" name="insideview_accept_box" id="insideview_accept_box" onClick='toggleGettingStartedButton();'/>&nbsp;<?php echo $this->_tpl_vars['connector_language']['LBL_TOS0']; ?>
<a href='http://www.insideview.com/cat-terms-use.html' target='_blank' style='text-decoration: none;'><?php echo $this->_tpl_vars['connector_language']['LBL_TOS1']; ?>
</a><?php echo $this->_tpl_vars['connector_language']['LBL_TOS2']; ?>
<a href='http://www.insideview.com/cat-privacy.html' target='_blank' style='text-decoration: none;'><?php echo $this->_tpl_vars['connector_language']['LBL_TOS3']; ?>
</a>.
         <button name="insideview_accept_button" id="insideview_accept_button" onclick="allowInsideView(); return false;" class='button primary' style='height: 25px; float: right; border: 1px solid #821200; background-color: #eeeeee; background-image: none; text-shadow: 1px 1px #FFFFFF; color: #222; margin-bottom: 0px; background-image: -moz-linear-gradient(center top , #F9F9F9 0%, #F2F2F2 50%, #F1F1F1 50%, #DDDDDD 100%); background-image: -webkit-gradient( linear,left top,left bottom,color-stop(0, #f9f9f9),color-stop(.5, #F2F2F2),color-stop(.5, #F1F1F1),color-stop(1, #DDDDDD)); filter: progid:DXImageTransform.Microsoft.gradient(startColorstr="#f9f9f9", endColorstr="#DDDDDD");'><?php echo $this->_tpl_vars['connector_language']['LBL_GET_STARTED']; ?>
</button>
