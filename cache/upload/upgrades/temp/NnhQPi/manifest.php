...
'name' => 'Add new Logic Hook for AOS_Quotes Module',
'description' => 'Add new Logic Hook for AOS_Quotes Module installation package.',
...
'id' => 'CG_LogicHook',
'mkdir' => array(
array('path' => 'custom/modules/AOS_Quotes'),
), 
'copy' => array(
array(
'from' => '<basepath>/file/file.php',
'to'   => 'custom/modules/AOS_Quotes/file.php',
),
),
'logic_hooks' => array(
array(
...
'hook' => 'after_save',
'order' => 96,
'description' => 'Add new Logic Hook for AOS_Quotes Module',
'file' => 'custom/modules/AOS_Quotes/file.php',
