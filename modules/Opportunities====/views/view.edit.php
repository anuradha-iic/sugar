...
EOQ;
	...
	function displayJS() {
			...
			echo ' document.getElementById("total_amount").setAttribute("readonly", "");';
			echo ' getCountRC();';
			...
			echo ' var rc_total = parseInt(mrc)+parseInt(nrc); ';	
			echo ' document.getElementById("total_amount").value = rc_total;';
			echo ' } ';
			echo '</script>';
 	}
}
