...
$data = "";
	...
	else
	{
		...
		{  
		   $data .= '<table style="border: 1pt none currentcolor; width: 100%; border-spacing: 0pt; border-collapse: collapse;" cellpadding="0" cellspacing="0" border="1"><tr>
<td style="border-style: solid; border-width: 0.5px; padding: 2px 6px; width: 20%;" valign="top"><span style="font-size: x-small;"><strong>Role(s)</strong></span></td>
<td style="border-style: solid; border-width: 0.5px; padding: 2px 6px; width: 35%;" valign="top"><span style="font-size: x-small;"><strong>Name</strong></span></td>
<td style="border-style: solid; border-width: 0.5px; padding: 2px 6px; width: 15%;" valign="top"><span style="font-size: x-small;"><strong>Phone</strong></span></td> 
<td style="border-style: solid; border-width: 0.5px; padding: 2px 6px; width: 30%;" valign="top"><span style="font-size: x-small;"><strong>Email</strong></span></td>
</tr>'; 
	       ...
	       $data .= '<tr>
				<td style="width: 20%; height: 12px;" valign="top"><span style="font-size: x-small;">'.$contacttype.'&nbsp;</span></td>
				<td style="width: 35%;height: 12px;" valign="top"><span style="font-size: x-small;">'.$val['name'].'&nbsp;</span></td>
				<td style="width: 15%;height: 12px;" valign="top"><span style="font-size: x-small;">'.'<b>Work:</b> '.$val['work'].'<br> <b>Mobile:</b>'.$val['mobile'].'&nbsp;</span></td> 
				<td style="width: 30%;height: 12px;" valign="top"><span style="font-size: x-small;">'.$val['email'].'&nbsp;</span></td>
			</tr>';
		   }
...
$data = "";
	...
	else
	{
		...
		{
		   $data .= '<table style="width: 100%; border: 1px solid black; border-collapse: collapse;" border="0" cellpadding="0" cellspacing="0"><tr>
<td style="border-style: solid; border-width: 0.5px; padding: 2px 6px; width: 20%;"><span style="font-size: x-small;"><strong>Name</strong></span></td>
<td style="border-style: solid; border-width: 0.5px; padding: 2px 6px; width: 35%;"><span style="font-size: x-small;"><strong>Street</strong></span></td>
<td style="border-style: solid; border-width: 0.5px; padding: 2px 6px; width: 15%;"><span style="font-size: x-small;"><strong>City</strong></span></td>
<td style="border-style: solid; border-width: 0.5px; padding: 2px 6px; width: 30%;"><span style="font-size: x-small;"><strong>State/Zip</strong></span></td>
</tr>'; 
		     $temp = 0;
		      foreach($serviceAddressArray as  $key=>$val) { 
	       $data .= '<tr> <td style="width: 20%; height: 12px;" valign="top"><span style="font-size: x-small;">Service Address '.$temp++.'</span></td>
				<td style="width: 35%;height: 12px;" valign="top"><span style="font-size: x-small;">'.chunk_split($val['service_address_street'], 20, "<br />").'&nbsp;</span></td>
				<td style="width: 15%;height: 12px; " valign="top"><span style="font-size: x-small;">'.chunk_split($val['service_address_city'], 15, "<br />").'&nbsp;</span></td>
				<td style="width: 30%;height: 12px; " valign="top"><span style="font-size: x-small;">'.chunk_split($val['service_address_state'], 15, "<br />"). $val['service_address_postalcode'] .'&nbsp;</span></td>  
			</tr>';
		   }
		 $data .= '</table> <table style="width: 100%;" border="0" cellpadding="0" cellspacing="0"><tr><td colspan="5">&nbsp;</td></tr></table>';
	   ...
	   else
	   {
		  ...
		  $text = str_replace('--Service Address--', "", $text);
	   }
    }
