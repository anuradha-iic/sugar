...
<td style="border-style: solid; border-width: 0.5px; padding: 2px 6px; width: 20%;" valign="top"><span style="font-size: x-small;"><strong>Name</strong></span></td>
<td style="border-style: solid; border-width: 0.5px; padding: 2px 6px; width: 20%;" valign="top"><span style="font-size: x-small;"><strong>Work</strong></span></td>
<td style="border-style: solid; border-width: 0.5px; padding: 2px 6px; width: 20%;" valign="top"><span style="font-size: x-small;"><strong>Mobile</strong></span></td>
<td style="border-style: solid; border-width: 0.5px; padding: 2px 6px; width: 20%;" valign="top"><span style="font-size: x-small;"><strong>Email</strong></span></td>
</tr>'; 
	       ...
	       $data .= '<tr>
				<td style="width: 20%; height: 12px;" valign="top"><span style="font-size: x-small;">'.chunk_split($contacttype, 20, "<br />").'&nbsp;</span></td>
...
$data = "";
	...
	else
	{
		...
		if( isset($serviceAddressArray) && is_array($serviceAddressArray) && !empty($serviceAddressArray) )
		{
	       ...
	       $data .= '<tr>
				<td style="width: 200px; height: 12px;" valign="top"><span style="font-size: 12pt;">Service Address '.$temp++.'</span></td>
				<td style="width: 300px;height: 12px;" valign="top"><span style="font-size: 12pt;">'.chunk_split($val['service_address_street'], 20, "<br />").'&nbsp;</span></td>
				<td style="width: 200px;height: 12px; " valign="top"><span style="font-size: 12pt;">'.chunk_split($val['service_address_city'], 15, "<br />").'&nbsp;</span></td>
				<td style="width: 100px;height: 12px; " valign="top"><span style="font-size: 12pt;">'.chunk_split($val['service_address_state'], 15, "<br />").'&nbsp;</span></td> 
				<td style="width: 200px;height: 12px;" valign="top"><span style="font-size: 12pt;">'.chunk_split($val['service_address_postalcode'], 25, "<br />").'&nbsp;</span></td>
			</tr>';
		   }
		 $data .= '</table> <table style="width: 100%;" border="0" cellpadding="0" cellspacing="0"><tr><td colspan="5">&nbsp;</td></tr></table>';
