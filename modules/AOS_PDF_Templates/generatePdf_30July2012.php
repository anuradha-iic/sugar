 ...
 */
	...
	?>
	<!---
	<table cellpadding="0" cellspacing="0" border="0" width="25%" align="center" style="border: 1px solid; padding: 10px;">
     <tr>
	     <th colspan="2" style="font-weight: bold; text-align: center; border-bottom: 1px solid;">
	 ...
	 <tr>
		 ...
		 <td>
		       <?php //echo money_format('$%i', $SummaryDetails['total_discount']); ?>
		 </td>
	 </tr>
	 <tr>
		 <td>
		 ...
		 <td> 
			   <?php //echo money_format('$%i', $SummaryDetails['order_discount']); ?>
		 </td>
	 </tr>
	 <tr>
		 <td>
		 ...
		 <td> 
			   <?php //echo money_format('$%i', $SummaryDetails['total_nrc']); ?>
		 </td>
	 </tr>
	 <tr>
		 <td>
		 ...
		 <td> 
			  <?php //echo money_format('$%i', $SummaryDetails['tax_amount']); ?>
		 </td>
	 </tr>
	 <tr>
		 <td>
		 ...
		 <td> 
			  <?php //echo money_format('$%i', $SummaryDetails['total_amount']); ?>
		 </td>
	 </tr>
    </table>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="25%" align="center" style="border: 1px solid; padding: 10px;">
		 <tr>
			   <td>
					 <b>Last Month Deposit:</b>  &nbsp;&nbsp;&nbsp; <?php //echo money_format('$%i', $SummaryDetails['total_lmd']); ?>
			   </td>
		 </tr>
	</table>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="25%" align="center" style="border: 1px solid; padding: 10px;">
	 ...
	 <tr>
		 ...
		 <td>
		       <?php //echo money_format('$%i', $SummaryDetails['product_subtotal_mrc']); ?>
		 </td>
	 </tr>
	 <tr>
		 <td>
	 ...
	 <tr>
		 ...
		 <td> 
			  <?php //echo money_format('$%i', $SummaryDetails['order_nrc_discont']); ?>
		 </td>
	 </tr>
	 <tr>
		 <td>
			  <b>OneTime Grand Total:</b>
		 </td>
		 <td> 
			  <?php //echo money_format('$%i', $SummaryDetails['total_nrc_subtotal']); ?>
		 </td>
	 </tr>
	 <tr>
		 <td>
		 ...
		 <td> 
			  <?php //echo money_format('$%i', $SummaryDetails['shipping_amount']); ?>
		 </td>
	 </tr>
	 <tr>
		 <td>
		 ...
		 <td> 
			  <?php //echo money_format('$%i', $SummaryDetails['grand_total_nrc']); ?>
		 </td>
	 </tr>
    </table> --->
