...
$contacts_locations = '<table style="border: 1pt none currentcolor; width: 100%; border-spacing: 0pt; border-collapse: collapse;" border="0" cellspacing="0" cellpadding="0"><tbody><tr><td style="text-align: center; height: 10px; background-color: #0001f9;" colspan="5"><span style="font-size: x-small; color: #ffffff;"> <strong>CUSTOMER CONTACT INFORMATION</strong> </span></td>
</tr>'; 
...
$data = "";
		...
		{  
		   $data .= '<tr>
<td style="border-style: solid; border-width: 0.5px; text-align: center; width: 20%;" valign="top"><span style="font-size: x-small;"><strong>Role(s)</strong></span></td>
<td style="border-style: solid; border-width: 0.5px; text-align: center; width: 25%;" valign="top"><span style="font-size: x-small;"><strong>Name</strong></span></td>
<td style="border-style: solid; border-width: 0.5px; text-align: center; width: 25%;" valign="top"><span style="font-size: x-small;"><strong>Phone</strong></span></td> 
<td style="border-style: solid; border-width: 0.5px; text-align: center; width: 30%;" valign="top"><span style="font-size: x-small;"><strong>Email</strong></span></td>
</tr>'; 
	       ...
	       $data .= '<tr>
				<td style="width: 20%; height: 12px; border: 1px solid black; border-collapse: collapse;" padding: 2px 2px; valign="top"><span style="font-size: x-small;">'.$contacttype.'&nbsp;</span></td>
				<td style="width: 25%;height: 12px; border: 1px solid black; border-collapse: collapse; padding: 2px 2px;" valign="top"><span style="font-size: x-small;">'.$val['name'].'&nbsp;</span></td>
				<td style="width: 25%;height: 12px; border: 1px solid black; border-collapse: collapse; padding: 2px 2px;" valign="top"><span style="font-size: x-small;">'.'<b>Work:</b> &nbsp;'.$val['work'].'&nbsp; <b>Mobile:</b> &nbsp;&nbsp;'.$val['mobile'].'&nbsp;</span></td> 
				<td style="width: 30%;height: 12px; border: 1px solid black; border-collapse: collapse; padding: 2px 2px;" valign="top"><span style="font-size: x-small;">'.$val['email'].'&nbsp;</span></td>
			</tr>';
		   }
	   ...
	   {
	      $data .= "<tr><td colspan='5'><span style='font-size: x-small; text:align: center; color: red;'>There is not any records defined</span></td></tr>"; 
	   }
	    $contacts_locations .= $data;
    
 //echo $text; die; 
 
 $contacts_locations .= '<tr><td colspan="5">&nbsp;</td></tr><tr><td colspan="5">&nbsp;</td></tr><tr><td style="text-align: center; height: 10px; background-color: #0001f9;" colspan="5"><span style="font-size: x-small; color: #ffffff;"><strong>CUSTOMER LOCATION INFORMATION</strong></span></td></tr>';
...
$data = "";
		...
		{
		   $data .= '<tr>
<td style="border-style: solid; border-width: 0.5px; text-align: center; width: 20%;"><span style="font-size: x-small;"><strong>Name</strong></span></td>
<td style="border-style: solid; border-width: 0.5px; text-align: center; width: 35%;"><span style="font-size: x-small;"><strong>Street</strong></span></td>
<td style="border-style: solid; border-width: 0.5px; text-align: center; width: 15%;"><span style="font-size: x-small;"><strong>City</strong></span></td>
<td style="border-style: solid; border-width: 0.5px; text-align: center; width: 30%;"><span style="font-size: x-small;"><strong>State/Zip</strong></span></td> 
</tr>'; 
		     $temp = 0;
     ...
     {	 
	     $data .= '<tr>
			<td style="width: 20%; height: 12px; border: 1px solid black; border-collapse: collapse; padding: 2px 2px;" valign="top"><span style="font-size: x-small;">Shipping Address</span></td>
			<td style="width: 35%;height: 12px; border: 1px solid black; border-collapse: collapse; padding: 2px 2px;" valign="top"><span style="font-size: x-small;">'.$SummaryDetails['shipping_address_street'].'&nbsp;</span></td>
			<td style="width: 15%;height: 12px; border: 1px solid black; border-collapse: collapse; padding: 2px 2px;" valign="top"><span style="font-size: x-small;">'.$SummaryDetails['shipping_address_city'].'&nbsp;</span></td>
			<td style="width: 30%;height: 12px; border: 1px solid black; border-collapse: collapse; padding: 2px 2px;" valign="top"><span style="font-size: x-small;"> <span style="padding-right: 6px;"><b>State:</b> &nbsp;'.$SummaryDetails['shipping_address_state'].'</span>&nbsp;&nbsp;<b>Zip:</b>'.$SummaryDetails['shipping_address_postalcode'].'&nbsp;</span></td> 
			</tr>';	
      }
	 ...
	 if($SummaryDetails['billing_address_street'] != '' and $SummaryDetails['billing_address_city']!= '' and $SummaryDetails['billing_address_state'] != '' and $SummaryDetails['billing_address_postalcode'] != '')
      {
		$data .= '<tr>
				<td style="width: 20%; height: 12px; border: 1px solid black; border-collapse: collapse; padding: 2px 2px;" valign="top"><span style="font-size: x-small;">Billing Address</span></td>
				<td style="width: 35%;height: 12px; border: 1px solid black; border-collapse: collapse; padding: 2px 2px;" valign="top"><span style="font-size: x-small;">'.$SummaryDetails['billing_address_street'].'&nbsp;</span></td>
				<td style="width: 15%;height: 12px; border: 1px solid black; border-collapse: collapse; padding: 2px 2px;" valign="top"><span style="font-size: x-small;">'.$SummaryDetails['billing_address_city'].'&nbsp;</span></td>
				<td style="width: 30%;height: 12px; border: 1px solid black; border-collapse: collapse; padding: 2px 2px;" valign="top"><span style="font-size: x-small;"> <span style="padding-right: 6px;"><b>State:</b> &nbsp;'.$SummaryDetails['billing_address_state']. '</span>&nbsp;&nbsp; <b>Zip:</b> &nbsp;'. $SummaryDetails['billing_address_postalcode'] .'&nbsp;</span></td> 

				</tr>';		 
	  }	 
		      foreach($finalserviceAddressArray as  $key=>$val) { 
	       $data .= '<tr> <td style="width: 20%; height: 12px; border: 1px solid black; border-collapse: collapse; padding: 2px 2px;" valign="top"><span style="font-size: x-small;">'.$val['name'].'</span></td>
				<td style="width: 35%;height: 12px; border: 1px solid black; border-collapse: collapse; padding: 2px 2px;" valign="top"><span style="font-size: x-small;">'.$val['service_address_street'].'&nbsp;</span></td>
				<td style="width: 15%;height: 12px; border: 1px solid black; border-collapse: collapse; padding: 2px 2px;" valign="top"><span style="font-size: x-small;">'.$val['service_address_city'].'&nbsp;</span></td>
				<td style="width: 30%;height: 12px; border: 1px solid black; border-collapse: collapse; padding: 2px 2px;" valign="top"><span style="font-size: x-small;"> <span style="padding-right: 6px;"><b>State:</b> &nbsp;'.$val['service_address_state']. '</span>&nbsp;&nbsp;<b>Zip:</b> &nbsp;'. $val['service_address_postalcode'] .'&nbsp;</span></td>  
			</tr>';
		   }
		 $data .= '<tr><td colspan="5">&nbsp;</td></tr>'; 
	   }
