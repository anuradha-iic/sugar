...
//		echo '<pre>';
//	print_r($product_quote->field_defs);
//	die;
...
$data = "";
		...
		{  
		   $data .= '<tr>
<td style="border-style: solid; border-width: 1px; text-align: left; width: 20%;" valign="top"><span style="font-size: x-small;"><strong>Role(s)</strong></span></td>
<td style="border-style: solid; border-width: 1px; text-align: left; width: 25%;" valign="top"><span style="font-size: x-small;"><strong>Name</strong></span></td>
<td style="border-style: solid; border-width: 1px; text-align: left; width: 25%;" valign="top"><span style="font-size: x-small;"><strong>Phone</strong></span></td> 
<td style="border-style: solid; border-width: 1px; text-align: left; width: 30%;" valign="top"><span style="font-size: x-small;"><strong>Email</strong></span></td>
</tr>'; 
	   ...
	   {
	      $data .= "<tr><td colspan='5'><span style='font-size: x-small; text:align: center; color: red;'>There is not any records defined</span></td></tr></tbody></table>"; 
	   }
 ...
 $contacts_locations .= '<p>&nbsp;</p>
 <table style="border: 1pt none currentcolor; width: 100%; border-spacing: 0pt; border-collapse: collapse;" border="0" cellspacing="0" cellpadding="2"><tbody>
 <tr><td style="text-align: center; height: 10px; background-color: #0001f9;" colspan="5"><span style="font-size: x-small; color: #ffffff;"><strong>CUSTOMER LOCATION INFORMATION</strong></span></td>
 </tr>';
...
$data = "";
		...
		{
		   $data .= '<tr>
			<td style="border-style: solid; border-width: 1px; text-align: left; width: 25%;"><span style="font-size: x-small;"><strong>Name</strong></span></td>
			<td style="border-style: solid; border-width: 1px; text-align: left; width: 40%;"><span style="font-size: x-small;"><strong>Street</strong></span></td>
			<td style="border-style: solid; border-width: 1px; text-align: left; width: 15%;"><span style="font-size: x-small;"><strong>City</strong></span></td>
			<td style="border-style: solid; border-width: 1px; text-align: left; width: 10%;"><span style="font-size: x-small;"><strong>State</strong></span></td> 
			<td style="border-style: solid; border-width: 1px; text-align: left; width: 10%;"><span style="font-size: x-small;"><strong>Zip</strong></span></td> 
			</tr>'; 
		     $temp = 0;
     ...
     {	 
	     $data .= '<tr>
				<td style="width: 25%; height: 12px; border: 1px solid black; border-collapse: collapse; padding: 2px 2px;" valign="top"><span style="font-size: x-small;">Shipping Address</span></td>
				<td style="width: 40%;height: 12px; border: 1px solid black; border-collapse: collapse; padding: 2px 2px;" valign="top"><span style="font-size: x-small;">'.$SummaryDetails['shipping_address_street'].'&nbsp;</span></td>
				...
				<td style="width: 10%;height: 12px; border: 1px solid black; border-collapse: collapse; padding: 2px 2px;" valign="top"><span style="font-size: x-small;">'.$SummaryDetails['shipping_address_state'].'&nbsp;</span></td> 
				<td style="width: 10%;height: 12px; border: 1px solid black; border-collapse: collapse; padding: 2px 2px;" valign="top"><span style="font-size: x-small;">'.$SummaryDetails['shipping_address_postalcode'].'&nbsp;</span></td>
				</tr>';	
      }
	 ...
	 if($SummaryDetails['billing_address_street'] != '' and $SummaryDetails['billing_address_city']!= '' and $SummaryDetails['billing_address_state'] != '' and $SummaryDetails['billing_address_postalcode'] != '')
      {
		$data .= '<tr>
				<td style="width: 25%; height: 12px; border: 1px solid black; border-collapse: collapse; padding: 2px 2px;" valign="top"><span style="font-size: x-small;">Billing Address</span></td>
				<td style="width: 40%;height: 12px; border: 1px solid black; border-collapse: collapse; padding: 2px 2px;" valign="top"><span style="font-size: x-small;">'.$SummaryDetails['billing_address_street'].'&nbsp;</span></td>
				...
				<td style="width: 10%;height: 12px; border: 1px solid black; border-collapse: collapse; padding: 2px 2px;" valign="top"><span style="font-size: x-small;">'.$SummaryDetails['billing_address_state'].'&nbsp;</span></td> 
				<td style="width: 10%;height: 12px; border: 1px solid black; border-collapse: collapse; padding: 2px 2px;" valign="top"><span style="font-size: x-small;">'.$SummaryDetails['billing_address_postalcode'].'&nbsp;</span></td>
				</tr>';		 
	  }	 
		      foreach($finalserviceAddressArray as  $key=>$val) { 
	       $data .= '<tr> 
				<td style="width: 25%; height: 12px; border: 1px solid black; border-collapse: collapse; padding: 2px 2px;" valign="top"><span style="font-size: x-small;">'.$val['name'].'</span></td>
				<td style="width: 40%;height: 12px; border: 1px solid black; border-collapse: collapse; padding: 2px 2px;" valign="top"><span style="font-size: x-small;">'.$val['service_address_street'].'&nbsp;</span></td>
				...
				<td style="width: 10%;height: 12px; border: 1px solid black; border-collapse: collapse; padding: 2px 2px;" valign="top"><span style="font-size: x-small;">'.$val['service_address_state'].'&nbsp;</span></td>  
				<td style="width: 10%;height: 12px; border: 1px solid black; border-collapse: collapse; padding: 2px 2px;" valign="top"><span style="font-size: x-small;">'.$val['service_address_postalcode'].'&nbsp;</span></td> 
			</tr>';
		   }
...
$text = str_replace('--Other Customer Locations Contacts--', $contacts_locations, $text);
	...
	if($task == 'pdf' || $task == 'emailpdf')
	{
		...
		ob_clean();
		try{ 
			$pdf=new mPDF('en','A4','','DejaVuSans',15,15,16,36,8,8);
			$pdf->setAutoFont(); 
