...
$data = "";
	...
	else
	{
       ...
       foreach($totalCts as  $key=>$val) {	
	    $data .= '<tr>
				<td style="width: 20%; height: 20px;" valign="top"><span style="font-size: x-small;">'.chunk_split($val['contacttype'], 17, "<br />").'&nbsp;</span></td>
				<td style="width: 20%;height: 20px;" valign="top"><span style="font-size: x-small;">'.chunk_split($val['name'], 20, "<br />").'&nbsp;</span></td>
				<td style="width: 20%;height: 20px;" valign="top"><span style="font-size: x-small;">'.chunk_split($val['work'], 15, "<br />").'&nbsp;</span></td>
				<td style="width: 20%;height: 20px;" valign="top"><span style="font-size: x-small;">'.chunk_split($val['mobile'], 15, "<br />").'&nbsp;</span></td>
				<td style="width: 20%;height: 20px;" valign="top"><span style="font-size: x-small;">'.chunk_split($val['email'], 25, "<br />").'&nbsp;</span></td>
			</tr>';
		}
		 $data .= '</table>';
